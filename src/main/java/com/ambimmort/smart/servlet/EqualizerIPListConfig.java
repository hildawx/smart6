 ...
 */
@WebServlet(name = "EqualizerIPListConfig", urlPatterns = {"/smart6/ipList"})
public class EqualizerIPListConfig extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = service.sendIPListConfig(hosts[0], hosts[1], data.toString());
            out.print(result);
        } finally {            
            out.close();
        }
